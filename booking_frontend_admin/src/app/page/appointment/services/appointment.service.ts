...
import { AppointmentResponse, OverallAppointment, ResponseSearchAppointment } from "../models/appointment.model";
...
export class AppointmentService {
    ...
    public getById(id: string): Observable<AppointmentResponse> {
        return this.http.get<AppointmentResponse>(`${environment.API_GATEWAY}/appointments`, {
            params: { id }
        })
    }
