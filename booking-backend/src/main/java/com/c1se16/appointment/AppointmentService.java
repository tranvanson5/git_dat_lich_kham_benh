...
public class AppointmentService {
    ...
    public AppointmentSearchResponse getById(String id) {
        ...
        return new AppointmentSearchResponse() {
            ...
            public String getFullName() {
                return appointment.getFullName();
            }
            ...
            public String getDepartmentName() {
                return Optional.ofNullable(appointment.getDepartment())
            ...
            public String getSpecialistName() {
                return Optional.ofNullable(appointment.getSpecialist())
                        .map(Specialist::getName)
                        .orElse("");
            }

            @Override
            public String getReasonOfPatient() {
                return appointment.getReasonOfPatient();
            }

            @Override
            public String getReasonOfManager() {
                return appointment.getReasonOfManager();
            }

            @Override
            public Date getApprovedDate() {
                return appointment.getApprovedDate();
            }

            @Override
            public Date getCancelDate() {
                return appointment.getCancelDate();
            }

            @Override
            public Date getDoneDate() {
                return appointment.getDoneDate();
            }
        };
    }
    ...
    public void finishAppointment(String id) {
        this.changeStatusFish(id, AppointmentStatus.DONE, null);
    }

    private void changeStatusFish(String id, AppointmentStatus status, Integer specialistId) {
        Appointment appointment = this.appointmentRepository.findById(id)
